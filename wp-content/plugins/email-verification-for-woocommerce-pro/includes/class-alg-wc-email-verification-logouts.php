...
class Alg_WC_Email_Verification_Logouts {
	 ...
	 * @version 1.8.3
	 * @since   1.6.0
	 * @todo    [dev] (maybe) force "activate" notice for guest users also
	 * @todo    [dev] (maybe) `alg_wc_ev_prevent_login_after_register`: `woocommerce_account_navigation` (doesn't seem to work though...)
	 */
	 ...
	 * @version 1.8.1
	 * @since   1.8.0
	 * @todo    [dev] (maybe) `wc_add_notice( alg_wc_ev()->core->messages->get_activation_message( $user_id ) );` (i.e. instead of redirect)
	 */
