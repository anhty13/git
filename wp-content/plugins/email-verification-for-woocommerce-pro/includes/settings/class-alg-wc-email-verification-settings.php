...
class Alg_WC_Email_Verification_Settings extends WC_Settings_Page {
	...
	function __construct() {
		...
		// Sections
		require_once( 'class-alg-wc-email-verification-settings-section.php' );
		require_once( 'class-alg-wc-email-verification-settings-general.php' );
		require_once( 'class-alg-wc-email-verification-settings-messages.php' );
		require_once( 'class-alg-wc-email-verification-settings-emails.php' );
		require_once( 'class-alg-wc-email-verification-settings-admin.php' );
		require_once( 'class-alg-wc-email-verification-settings-advanced.php' );
	}
