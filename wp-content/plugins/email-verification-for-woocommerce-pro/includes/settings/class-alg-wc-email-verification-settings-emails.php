	...
	function get_settings() {
		return array(
			array(
				...
				'desc'     => apply_filters( 'alg_wc_ev_settings', '<strong>' . sprintf( 'You will need %s plugin to change email settings.',
					'<a target="_blank" href="https://wpfactory.com/item/email-verification-for-woocommerce/">' .
						'Email Verification for WooCommerce Pro' . '</a>' ) . '</strong>' ),
			),
			array(
