...
class Alg_WC_Email_Verification_Settings_General extends Alg_WC_Email_Verification_Settings_Section {
	 ...
	 * @version 1.9.1
	 * @since   1.0.0
	 * @todo    [dev] (now) Logout unverified users on every page: better description
	 * @todo    [dev] (next) (maybe) `alg_wc_ev_delay_wc_email`: default to `yes`?
	 * @todo    [dev] `alg_wc_ev_expiration_time`: remove v1.7.0 note
	 * @todo    [dev] (maybe) more subsections?
	 * @todo    [dev] (maybe) `show_if_checked`
	 */
