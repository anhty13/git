...
class Alg_WC_Email_Verification_Admin {
	 ...
	 * @version 1.8.0
	 * @since   1.5.0
	 * @todo    [dev] (maybe) move more stuff here, e.g. settings, action links etc.
	 */
	 ...
	 * @version 1.7.0
	 * @since   1.7.0
	 * @todo    [dev] (next) customizable recurrence (e.g. `daily`)
	 */
	 ...
	 * @version 1.8.0
	 * @since   1.1.0
	 * @todo    [dev] (next) (maybe) new action: "expire" (i.e. make link expired) (i.e. remove `alg_wc_ev_activation_code_time` meta)
	 */
	 ...
	 * @version 1.0.1
	 * @since   1.0.0
	 * @todo    [dev] (maybe) new column: "expire"
	 * @todo    [dev] (maybe) add option to rename the column(s)
	 */
