...
= 3.9.2 =
* OTP Verification
 * Compatiability with WordPress 6.1
 * OTP Verification fixes for CF7 form.

= 3.9.1 =
* OTP Verification
 * Introduced WhatsApp OTP Verification test feature
 * Added user logged in check in Memberpress singlecheckout form
...
= 3.8.3 =
* OTP Verification
 * Published OTP verification on Everest Contact form
 * Published OTP verification on WooCommerce Profile form 
 * Advertised premium addons in addon tab
 ...
 * Added free SMS and Emails to Enterprise Plan
 ...
 * Introduced Globally Banned phone number.
 ...
 * WPML Compatibilty - Minor Fix
 * Added Video and Set up guide links for WCFM and Social Login OTP Verification.
 * OTP Verification : WooCommerce compatibilty 5.1.0
 * OTP Verification : Wordpress compatibility 5.7

= 3.6.3 =
* OTP Verification: Christimas Offers and minor fixes
 * Introduced Offers section.
 * Added Error/Success message handling in Custom Messages Addon.
 * Paid Membership Pro Improvement - Registered Phone Number in database.
 * Registration Magic Improvement - Minor fix in OTP Verification over Phone.
 ...
 * Added AWS SNS gateway support in Custom gateway plugin.
...
= 2.8 =
* OTP Verification: Added SMS Verification for default form
 * Added support for Theme My Login Form
 * Bug fixes for Ninja Form
 * UI fixes for Woocommerce Registration Form

= 2.7.5 =
* OTP Verification: Fixed issue with support form
